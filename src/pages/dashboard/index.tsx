          ...
          <div className="p-6 grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-slate-50 rounded-xl p-5 border border-slate-100">
              ...
              <p className="text-sm text-slate-600 mb-4 leading-relaxed">
                Rasio arus kas bersih Anda ({(metrics ? (metrics.netCash / metrics.totalIncome) * 100 : 0).toFixed(1)}%) sangat sehat. 
                Pengeluaran terkendali dengan baik. Disarankan untuk mengalokasikan surplus ke dana darurat atau investasi bisnis.
              </p>
              <Button
                size="sm"
                variant="outline"
